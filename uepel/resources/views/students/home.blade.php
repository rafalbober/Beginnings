                ...
                <div class="col-md-6 justify-content-center" style="background: #ffffff">
                    <div class="card md-12">
                        <div class="card-body text-center">
                            ...
                            <div class="col mb-12">
                                <a class="btn btm-md " style="background-color: #D3D3D3; margin: 1%; width: 80%" href="{{route('student.index',$student->id)}}" >About me </a> </div>
                            <div class="col mb-12">
                                <a class="btn btm-md " style="background-color: #D3D3D3; margin: 1%; width: 80%" href="{{route('student.my_subjects')}}">My Subjects</a> </div>
                            <div class="col mb-12">
                                <a class="btn btm-md " style="background-color: #D3D3D3; margin: 1%; width: 80%" href="{{route('student.subjects_show')}}"> Available Subjects</a> </div>
                        </div>
                    </div>
                </div>
            </div>
