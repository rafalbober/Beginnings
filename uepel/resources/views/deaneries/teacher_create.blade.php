    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6" style="background: rgba(0,0,0,0.4); margin-top: 2%;  box-shadow: 1px 4px 40px black">
                <h2 class="text-center" style="margin: 2%">New Teacher</h2>
                @if( $errors->any() )
                ...
                <form method="POST" action="{{route('deaneries.teacher_store')}}">
                    ...
                    <input type = "password" name = "password" placeholder="Password" style="width:100%;background: transparent; border-radius: 0px; border: 0px; border-bottom: 1px solid gray; color: white; height: 40px; padding-left:10px; font-size: 15px ">
